...
[Download the latest release (version 0.99.0)](https://github.com/peter88213/noveltree_aeon2/raw/main/dist/noveltree_aeon2_v0.99.0.zip)

- Extract the "noveltree_aeon2_v0.99.0" folder from the downloaded zipfile "noveltree_aeon2_v0.99.0.zip".
