...
[Download the latest release (version 3.5.0)](https://github.com/peter88213/noveltree_aeon2/raw/main/dist/novelyst_aeon2_v3.5.0.zip)

- Extract the "novelyst_aeon2_v3.5.0" folder from the downloaded zipfile "novelyst_aeon2_v3.5.0.zip".
